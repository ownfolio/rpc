...
export type RpcCallInputSchema<T> = T extends RpcCall<infer _Ctx, infer I, infer _O> ? I : never
export type RpcCallInputType<T> = z.infer<RpcCallInputSchema<T>>
export type RpcCallOutputSchema<T> = T extends RpcCall<infer _Ctx, infer _I, infer O> ? O : never
...
export type RpcClient<R extends AnyRpcRouter> = {
